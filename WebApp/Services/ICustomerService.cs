...
public interface ICustomerService
{
    ...
    // API & CRUD extensions
    Task<IEnumerable<KhachHangModel>> GetAllCustomersAsync();
    Task<KhachHangModel?> GetCustomerByIdAsync(string id);
    Task<OperationResult<KhachHangModel>> CreateCustomerAsync(KhachHangModel model);
    Task<OperationResult> UpdateCustomerDetailsAsync(KhachHangModel model);
