...
class DetailScreen extends StatefulWidget {
  ...
  const DetailScreen(
      {super.key, required this.productService, required this.product});
...
class _DetailScreenState extends State<DetailScreen> {
  ...
  void initState() {
    super.initState();
    futureProductDetail =
        widget.productService.getProductDetail(widget.product.id);
  }
            ...
            onPressed: () {
              showMenu(
                ...
                position: const RelativeRect.fromLTRB(
                    1000, 70, 0, 0), // you might need to adjust these values
                items: [
                  const PopupMenuItem(
                    value: 'facebook',
                ...
                if (value == 'facebook') {
                  final productUrl =
                      AppEnv.web('/Product/Detail/${widget.product.id}')
                          .toString();
                  final url = Uri.https('www.facebook.com',
                      '/sharer/sharer.php', {'u': productUrl});
                  ...
                  children: <Widget>[
                    ClipRRect(
                      borderRadius: BorderRadius.circular(
                          20.0), // Adjust the radius to change how rounded the corners are
