                    ...
                    return Column(
                      children: [
                        ListTile(
                          ...
                          title: Text(
                            'Đơn hàng ${order.idOrder.substring(order.idOrder.length - 10)}',
                          ), // Thay thế 'Đơn hàng $index' bằng dữ liệu thực tế
                          subtitle: Text(
                          ...
                          onTap: () {
                            ...
                            Navigator.pushReplacement(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    OrderDetailScreen(order: order.idOrder),
                              ),
                            );
                          ...
                          isThreeLine:
                              true, // Thay thế 'Chi tiết đơn hàng $index' bằng dữ liệu thực tế
                        ),
